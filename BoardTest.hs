...
tests = TestList [
  ...
  "printBoard" ~: TestList [
   ...
   "stringAct" ~: TestList [
      ...
      stringAct "q" ~?= Just Question,
      stringAct "g" ~?= Nothing,
      stringAct "rabbit" ~?= Nothing,
      stringAct "bunny" ~?= Nothing,
      stringAct "questioned" ~?= Nothing,
      stringAct "revealed" ~?= Nothing,
      stringAct "flagged" ~?= Nothing,
      stringAct "failed" ~?= Nothing
      ]
   ]
